...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="testObjectTypeId">
        <xsl:message terminate="no">Set the testObjectType, this is an ID for the type of resource in the test from a fixed list for ETF. NOTE: don't include EID in the value. Defaults to Metadata: 5a60dded-0cb0-4977-9b06-16c6c2321d2e. For other values, see http://docs.etf-validator.net/v2.0/Developer_manuals/Developing_Executable_Test_Suites.html#basex-test-object-types </xsl:message>
        <xsl:value-of select="'5a60dded-0cb0-4977-9b06-16c6c2321d2e'"/>
    </xsl:param>
